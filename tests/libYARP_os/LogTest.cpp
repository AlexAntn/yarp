...
TEST_CASE("os::LogTest", "[yarp::os]")
{
    ...
    SECTION("Test yErrorCustomTime")
    {
        ...
        CNT yCErrorCustomTime(now, LOG_COMPONENT, "This is an error with a component");
        CNT yCErrorCustomTime(now, LOG_COMPONENT, "This is %s (%d)", "an error with a component", i);
            ...
            t = std::thread([start]()
            {
                while (true) {
                    ...
                    CNT yTraceCustomTimeThreadThrottle(now, period,
                        ...
                        yarp::os::NetType::toHexString(yarp::os::Thread::getKeyOfCaller()).c_str(),
                        period);
                    CNT yCTraceCustomTimeOnce(now, LOG_COMPONENT,
                        "[Time: %f][Thread id: 0x%s] This line is printed only by the first thread coming here",
                        now - start,
                        yarp::os::NetType::toHexString(yarp::os::Thread::getKeyOfCaller()).c_str());
                    CNT yCTraceCustomTimeThreadOnce(now, LOG_COMPONENT,
                        "[Time: %f][Thread id: 0x%s] This line is printed by every thread",
                        now - start,
                        yarp::os::NetType::toHexString(yarp::os::Thread::getKeyOfCaller()).c_str());
                    CNT yCTraceCustomTimeThrottle(now, LOG_COMPONENT, period,
                        "[Time: %f][Thread id: 0x%s] This line is printed at most once every %fs",
                        now - start,
                        yarp::os::NetType::toHexString(yarp::os::Thread::getKeyOfCaller()).c_str(),
                        period);
                    CNT yCTraceCustomTimeThreadThrottle(now, LOG_COMPONENT, period,
                        "[Time: %f][Thread id: 0x%s] This line is printed at most once every %fs by every thread",
                        now - start,
                        yarp::os::NetType::toHexString(yarp::os::Thread::getKeyOfCaller()).c_str(),
                        period);
            ...
            t = std::thread([start]()
            {
                while (true) {
                    ...
                    CNT yDebugCustomTimeThreadThrottle(now, period,
                        ...
                        yarp::os::NetType::toHexString(yarp::os::Thread::getKeyOfCaller()).c_str(),
                        period);
                    CNT yCDebugCustomTimeOnce(now, LOG_COMPONENT,
                        "[Time: %f][Thread id: 0x%s] This line is printed only by the first thread coming here",
                        now - start,
                        yarp::os::NetType::toHexString(yarp::os::Thread::getKeyOfCaller()).c_str());
                    CNT yCDebugCustomTimeThreadOnce(now, LOG_COMPONENT,
                        "[Time: %f][Thread id: 0x%s] This line is printed by every thread",
                        now - start,
                        yarp::os::NetType::toHexString(yarp::os::Thread::getKeyOfCaller()).c_str());
                    CNT yCDebugCustomTimeThrottle(now, LOG_COMPONENT, period,
                        "[Time: %f][Thread id: 0x%s] This line is printed at most once every %fs",
                        now - start,
                        yarp::os::NetType::toHexString(yarp::os::Thread::getKeyOfCaller()).c_str(),
                        period);
                    CNT yCDebugCustomTimeThreadThrottle(now, LOG_COMPONENT, period,
                        "[Time: %f][Thread id: 0x%s] This line is printed at most once every %fs by every thread",
                        now - start,
                        yarp::os::NetType::toHexString(yarp::os::Thread::getKeyOfCaller()).c_str(),
                        period);
            ...
            t = std::thread([start]()
            {
                while (true) {
                    ...
                    CNT yInfoCustomTimeThreadThrottle(now, period,
                        ...
                        yarp::os::NetType::toHexString(yarp::os::Thread::getKeyOfCaller()).c_str(),
                        period);
                    CNT yCInfoCustomTimeOnce(now, LOG_COMPONENT,
                        "[Time: %f][Thread id: 0x%s] This line is printed only by the first thread coming here",
                        now - start,
                        yarp::os::NetType::toHexString(yarp::os::Thread::getKeyOfCaller()).c_str());
                    CNT yCInfoCustomTimeThreadOnce(now, LOG_COMPONENT,
                        "[Time: %f][Thread id: 0x%s] This line is printed by every thread",
                        now - start,
                        yarp::os::NetType::toHexString(yarp::os::Thread::getKeyOfCaller()).c_str());
                    CNT yCInfoCustomTimeThrottle(now, LOG_COMPONENT, period,
                        "[Time: %f][Thread id: 0x%s] This line is printed at most once every %fs",
                        now - start,
                        yarp::os::NetType::toHexString(yarp::os::Thread::getKeyOfCaller()).c_str(),
                        period);
                    CNT yCInfoCustomTimeThreadThrottle(now, LOG_COMPONENT, period,
                        "[Time: %f][Thread id: 0x%s] This line is printed at most once every %fs by every thread",
                        now - start,
                        yarp::os::NetType::toHexString(yarp::os::Thread::getKeyOfCaller()).c_str(),
                        period);
            ...
            t = std::thread([start]()
            {
                while (true) {
                    ...
                    CNT yWarningCustomTimeThreadThrottle(now, period,
                        ...
                        yarp::os::NetType::toHexString(yarp::os::Thread::getKeyOfCaller()).c_str(),
                        period);
                    CNT yCWarningCustomTimeOnce(now, LOG_COMPONENT,
                        "[Time: %f][Thread id: 0x%s] This line is printed only by the first thread coming here",
                        now - start,
                        yarp::os::NetType::toHexString(yarp::os::Thread::getKeyOfCaller()).c_str());
                    CNT yCWarningCustomTimeThreadOnce(now, LOG_COMPONENT,
                        "[Time: %f][Thread id: 0x%s] This line is printed by every thread",
                        now - start,
                        yarp::os::NetType::toHexString(yarp::os::Thread::getKeyOfCaller()).c_str());
                    CNT yCWarningCustomTimeThrottle(now, LOG_COMPONENT, period,
                        "[Time: %f][Thread id: 0x%s] This line is printed at most once every %fs",
                        now - start,
                        yarp::os::NetType::toHexString(yarp::os::Thread::getKeyOfCaller()).c_str(),
                        period);
                    CNT yCWarningCustomTimeThreadThrottle(now, LOG_COMPONENT, period,
                        "[Time: %f][Thread id: 0x%s] This line is printed at most once every %fs by every thread",
                        now - start,
                        yarp::os::NetType::toHexString(yarp::os::Thread::getKeyOfCaller()).c_str(),
                        period);
            ...
            t = std::thread([start]()
            {
                while (true) {
                    ...
                    CNT yErrorCustomTimeThreadThrottle(now, period,
                        ...
                        yarp::os::NetType::toHexString(yarp::os::Thread::getKeyOfCaller()).c_str(),
                        period);
                    CNT yCErrorCustomTimeOnce(now, LOG_COMPONENT,
                        "[Time: %f][Thread id: 0x%s] This line is printed only by the first thread coming here",
                        now - start,
                        yarp::os::NetType::toHexString(yarp::os::Thread::getKeyOfCaller()).c_str());
                    CNT yCErrorCustomTimeThreadOnce(now, LOG_COMPONENT,
                        "[Time: %f][Thread id: 0x%s] This line is printed by every thread",
                        now - start,
                        yarp::os::NetType::toHexString(yarp::os::Thread::getKeyOfCaller()).c_str());
                    CNT yCErrorCustomTimeThrottle(now, LOG_COMPONENT, period,
                        "[Time: %f][Thread id: 0x%s] This line is printed at most once every %fs",
                        now - start,
                        yarp::os::NetType::toHexString(yarp::os::Thread::getKeyOfCaller()).c_str(),
                        period);
                    CNT yCErrorCustomTimeThreadThrottle(now, LOG_COMPONENT, period,
                        "[Time: %f][Thread id: 0x%s] This line is printed at most once every %fs by every thread",
                        now - start,
                        yarp::os::NetType::toHexString(yarp::os::Thread::getKeyOfCaller()).c_str(),
                        period);
